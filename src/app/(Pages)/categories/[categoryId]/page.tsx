...
export default async function BrandDetails({params}:{params:Params}) {
    ...
    //get the Category's Id from params
    const { categoryId } = await params

    // get all Products that from this Category from Backend
        ...
        <>
                {
                    ...
                    <>
                    <div className='my-3'>
                        <h1 className='text-3xl font-bold tracking-tight text-main'>{products[0].category.name}</h1>
                    ...
                    <div className='flex justify-center items-center h-[75vh]'>
                        <h1>There is no Products from this Category....😥</h1>
                    </div>
                }
        </>
    )
